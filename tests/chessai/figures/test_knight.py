...
class TestKnight:
    def test_knight_all_moves(self):
        ...
        assert set([b_knigh_cord]) == set((mov[CURNT] for mov in potential_moves))
    ...
    def test_knight(self):
        ...
        assert set([w_pawn_cord, (7, 3), (4, 2), (3, 3), w_rook_cord, (4, 6)]) == set(
    ...
    def test_knight_two_moves(self):
        ...
        assert set([w_knigh_cord]) == set((mov[CURNT] for mov in potential_moves))

        assert set([(7, 6), (6, 7)]) == set((mov[DEST] for mov in potential_moves))
