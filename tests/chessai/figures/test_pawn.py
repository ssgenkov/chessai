...
class TestPawn:
    ...
    def test_b_pawn_init(self):
        ...
        assert set(potential_moves) == set([w_rook_cord, w_bishop_cord, (6,4), (5,4)])
        ...
        assert set(potential_moves) == set([(6,4), (5,4)])
    ...
    def test_b_pawn_mid(self):
        ...
        assert set(potential_moves) == set([(5,4)])
    ...
    def test_w_pawn_init(self):
        ...
        assert set(potential_moves) == set([b_rook_cord, b_bishop_cord, (3,4), (4,4)])
        ...
        assert set(potential_moves) == set([(3,4), (4,4)])
    ...
    def test_w_pawn_mid(self):
        ...
        assert set(potential_moves) == set([(4,4)])
