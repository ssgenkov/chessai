...
class TestKingVision:
    ...
    def test_white_king_vision(self):
        ...
        expected_vision = {}
        expected_vision[self.w_queen_cord] = (self.state.get_figure_by_cord(self.w_queen_cord), Move.LU_DIAG)
        expected_vision[self.w_pawn3_cord] = (self.state.get_figure_by_cord(self.w_pawn3_cord), Move.UP)
        expected_vision[self.w_pawn2_cord] = (self.state.get_figure_by_cord(self.w_pawn2_cord), Move.LEFT)
    ...
    def test_black_king_vision(self):
        ...
        expected_vision = {}
        expected_vision[self.b_rook1_cord] = (self.state.get_figure_by_cord(self.b_rook1_cord), Move.RU_DIAG)
        expected_vision[self.w_pawn5_cord] = (self.state.get_figure_by_cord(self.w_pawn5_cord), Move.LD_DIAG)
        expected_vision[self.b_pawn3_cord] = (self.state.get_figure_by_cord(self.b_pawn3_cord), Move.DOWN)
        expected_vision[self.w_rook2_cord] = (self.state.get_figure_by_cord(self.w_rook2_cord), Move.RD_DIAG)
